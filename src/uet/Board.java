...
public class Board implements IRender {
    ...
    public void render(Screen screen) {
        ...
        for (int y = y0; y < y1; y++) {
            for (int x = x0; x < x1; x++) {
                if (x + y * _levelLoader.getWidth() < 0) {
                    System.out.printf("x0: %d, y0: %d, x1: %d, y1: %d", x0, y0, x1, y1);
                    System.out.printf("x: %d, y: %d, width: %d", x, y, _levelLoader.getWidth());
                }
