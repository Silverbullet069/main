...
//    public static final int TILE_SIZE = DEFAULT_SIZE * 3;
    ...
    public Sprite(String path) {
        ...
        try {
            ...
            bigRawLength = w;
            bigRawPixels = new int[w * w];

            image.getRGB(0, 0, w, w, bigRawPixels, 0, w);
        } catch (IOException e) {
            bigRawPixels = new int[0];
            e.printStackTrace();
            System.exit(0);
        }

        SIZE = 32;
        _pixels = new int[Game.TILES_SIZE * Game.TILES_SIZE];
        int skipPixel = bigRawLength / SIZE;
        System.out.println(skipPixel);
        int pixelX = 0, pixelY = 0;
        int rawPixelX = 0, rawPixelY = 0;

        for (; pixelY < SIZE && rawPixelY < bigRawLength; rawPixelY++) {
            if (rawPixelY % skipPixel != 0) {
                continue;
            }
            pixelX = 0;
            for (rawPixelX = 0; pixelX < SIZE && rawPixelX < bigRawLength; rawPixelX++) {
                if (rawPixelX % skipPixel != 0) {
                    continue;
                }
                _pixels[pixelX + pixelY * SIZE] = bigRawPixels[rawPixelX + rawPixelY * bigRawLength];
                pixelX++;
            }
            pixelY++;
        }
...
//    public static Sprite brick = new Sprite(16, 7, 0, SpriteSheet.tiles, 16, 16);
    public static Sprite brick = new Sprite("res/UI/image/sprites/jungle stage sprites/BRICK - jungle stage.png");
    public static Sprite grass = new Sprite("res/UI/image/sprites/jungle stage sprites/GRASS - jungle stage.png");
//    public static Sprite wall = new Sprite(16, 5, 0, SpriteSheet.tiles, 16, 16);
    public static Sprite wall = new Sprite("res/UI/image/sprites/jungle stage sprites/WALL - jungle stage.png");
...
//    public static Sprite bomb = new Sprite(16, 0, 3, SpriteSheet.tiles, 15, 15);
    public static Sprite bomb = new Sprite("res/UI/image/sprites/bomb sprites/bomb0.png");
    public static Sprite bomb_1 = new Sprite("res/UI/image/sprites/bomb sprites/bomb1.png");
//    public static Sprite bomb_1 = new Sprite(16, 1, 3, SpriteSheet.tiles, 13, 15);
    public static Sprite bomb_2 = new Sprite("res/UI/image/sprites/bomb sprites/bomb2.png");
